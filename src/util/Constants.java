...
public class Constants {
    ...
    public static final Color EXPLORE_COLOR_0 = new Color(0.2f, 0.6f, 0.86f, 1.0f);
    public static final Color EXPLORE_COLOR_1 = new Color(0.2f, 0.6f, 0.86f, 0.9f);
    public static final Color EXPLORE_COLOR_2 = new Color(0.2f, 0.6f, 0.86f, 0.8f);
    public static final Color EXPLORE_COLOR_3 = new Color(0.2f, 0.6f, 0.86f, 0.7f);
    public static final Color EXPLORE_COLOR_4 = new Color(0.2f, 0.6f, 0.86f, 0.6f);
    public static final Color EXPLORE_COLOR_5 = new Color(0.2f, 0.6f, 0.86f, 0.5f);
}
